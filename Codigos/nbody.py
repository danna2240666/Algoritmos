...
#7 columnas, 3 coordenadas posicion, 3 valores velocidad y la masa
...
while (t < t_fin): #acá controlamos el número de pasos de tiempo
    for m1 in range(n_cuerpos): # for para recorrer cada cuerpo, m1 quiere decir, indice de masa 1
        ...
        for m2 in range(n_cuerpos): # for para recorrer cada cuerpo, esta vez para ser la masa 2
            ...
            if m2 != m1:
                ...
                vector_r = entidades_orbitales[m1, :3] - entidades_orbitales[m2, :3] #:3 es viendo posiciones xyz
                ...
                aceleracion = (-1.0 * G * (entidades_orbitales[m2, 6])) / (mag_r**2) #usando Gm1m2/r^2=m1a, [m2,6]=masa
                # cálculo de los vectores unitarios y las proyecciones de la aceleración
                vector_ru = vector_r / mag_r #vector unitario direccion
        ...
        entidades_orbitales[m1, 3:6] = entidades_orbitales[m1, 3:6] + a_g * dt  #v= v0 + at
        '''
    ...
    for m1 in range(n_cuerpos):
        ...
        entidades_orbitales[m1, :3] = entidades_orbitales[m1, :3] + entidades_orbitales[m1, 3:6] * dt #x= x0 + vt= x0 + (v0 + at)t
